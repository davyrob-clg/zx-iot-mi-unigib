...
//    ESP_LOGI(TAG, "FILEMENU : num_entries %d offs %d ", num_entries, offset);
 ...
 //  return true;
    ...
    zxfimg_cpzx_video (0, (const uint8_t *) "\x83\x83\x04\x04\x00\x04\x00\x00\x02\x00\x00\x00\x00\x00\x05\x00\x00\x27\x3e\x00\x3a\x33\x2e\x2c\x2e\x27", 26);
    zxfimg_cpzx_video (1, (const uint8_t *) "\x00\x06\x00\x02\x06\x00\x83\x00\x84\x01\x06\x03\x04\x84\x03\x01", 16);
    zxfimg_cpzx_video (2, (const uint8_t *) "\x81\x83\x04\x06\x02\x04\x00\x00\x81\x04\x86\x83\x01\x02\x83\x04", 16);
